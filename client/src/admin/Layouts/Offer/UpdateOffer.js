...
import { updatesOffer } from '../../Helper/Offer';
...
const UpdateOffer = () => {
    ...
    const { id, name, feature1, feature2, feature3, isActive } = values;
    ...
    const onSubmit = async (event) => {
        ...
        try {
            ...
            if (id === '') {
                ...
                const response = await updatesOffer(user._id, token, { ...values })

                if (response.status === 200) {
                    setSuccess(true)
                    setValues({ ...values, id:'', name:'', feature1:'', feature2:'', feature3:'', isActive:false })
    ...
    useEffect(() => {
        ...
        return () => {
            setValues({ id:'', name:'', feature1:'', feature2:'', feature3:'', isActive:false })
        };
    ...
    const UpdateOfferForm = () => {
        ...
        return (
            <div className="row" style={rowStyles}>
                <div>
                    <h1 style={{color:"white", textAlign: "center", marginBottom: "30px"}}>Update Offer</h1>
                    <form>
                    <div className="form-group">
                            <input className="feedback-input" type="text" onChange={handleChange('id')} value={id} placeholder='Id of Offer'/>
                        </div>
                        <div className="form-group">
